...
export const getRequiredAction = ({ definition }: { definition: ChangeDefinition | ResourceDefinition }) => {
  if (definition.constructor === ChangeDefinition) return getRequiredActionForChange({ definition: definition as ChangeDefinition });
  if (definition.constructor === ResourceDefinition) return getRequiredActionForResource({ definition: definition as ResourceDefinition });
