...
import { ChangeDefinition, DefinitionPlan, DatabaseConnection, DatabaseLanguage, ControlConfig, RequiredAction } from '../../../../types';
...
describe('applyChange', () => {
  ...
  it('should be able to apply a new change', async () => {
    ...
    const [changeLogRows] = await connection.query({ sql: `select * from schema_control_change_log where change_id='${(plan.definition as ChangeDefinition).id}'` });
